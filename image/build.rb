...
images = {
  ...
  discourse: { name: 'discourse', tag: "adab1ts/discourse:#{version}", squash: true, layers_to_keep: 1 },
  discourse_test: { name: 'discourse_test', tag: "adab1ts/discourse_test:#{version}", squash: true, layers_to_keep: 2 },
